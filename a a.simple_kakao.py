...
dag = DAG(
    dag_id='slimple_kakao',
    start_date= datetime(2024, 4, 2,2,0, tzinfo=kst), # DAG 시작 날짜
...
def excel(**context):
    ...
    df.to_csv('심플채널고객_air.csv',index=False)
...
t1 = PythonOperator(task_id='get_id',
                    ...
                    op_args=['758d471ab4aa740fc36f50177e22bf73'],
...
def insertDB_record(**context):
    ...
    sql="INSERT INTO kakao (customernum, phone, brand, relation, plustime, updatetime, foreigner) VALUES (%s, %s, %s, %s, %s, %s, %s)"
