...
result3 = BeautifulSoup(response3.content, 'xml')
result4 = BeautifulSoup(response4.content, 'xml')
result5 = BeautifulSoup(response5.content, 'xml')
result6 = BeautifulSoup(response6.content, 'xml')
