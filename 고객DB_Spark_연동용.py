...
def DBinsert():
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/asimplecustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_1.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/asimplecustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_2.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/asimplecustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_3.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/bcococustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_1.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/bcococustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_2.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/bcococustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_3.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/csloomcustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_1.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/csloomcustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_2.xls.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/csloomcustomer/회원"+ now_format_year + "_" + now_format_month + "_" + now_format_day + "_3.xls.csv", header=True)
