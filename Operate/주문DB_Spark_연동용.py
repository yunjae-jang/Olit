...
def DBinsert():
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/모든 상태 주문_KR.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/모든 상태 주문_KR2.csv", header=True)
    ...
    df = spark.read.option("multiline", "true").csv("C:/Users/Manager/Downloads/모든 상태 주문_KR3.csv", header=True)
